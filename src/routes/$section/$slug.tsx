...
const pageMap: Record<string, PageDefinition> = {
  ...
  "ecosystem/infrastructure": {
    ...
    images: [
      "https://dtfhihp4ovn79.cloudfront.net/Infrastructure/ahub.jpg",
      "https://dtfhihp4ovn79.cloudfront.net/Infrastructure/collabrative+environment.png",
      "https://dtfhihp4ovn79.cloudfront.net/Infrastructure/confenrce+hall.jpg",
      "https://dtfhihp4ovn79.cloudfront.net/Infrastructure/iot+labs.jpeg",
    ],
    cards: [
