...
const ahubLogo = "https://dtfhihp4ovn79.cloudfront.net/AHub-Logo-1.png";
    ...
    links: [
      {
        ...
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/vision-roadmap.png",
      },
      {
        label: "Operational Model",
        href: "/approach/operational-model",
        description: "How we build, validate, and scale startups.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/operational_model.png",
      },
    ],
    compact: true,
  },
    ...
    links: [
      {
        ...
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/startup_porfolio.png",
      },
      {
        label: "Infrastructure",
        href: "/ecosystem/infrastructure",
        description: "Labs, halls, and collaboration spaces.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/infasrtucture.png",
      },
      {
        label: "Partners",
        href: "/ecosystem/partners",
        description: "Institutional logos and collaboration network.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/partners.png",
      },
      {
        label: "Startup Events",
        href: "/events/startups-events",
        description: "Demo days, pitch sessions, and founder meetups.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/startup_events.png",
      },
    ],
  },
  associate: {
    ...
    links: [
      {
        ...
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/join_us.png",
      },
      {
        label: "Pitch To Us",
        href: "/programs/pitch-to-us",
        description: "Startup submission and founder intake.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/pitch_to_us.png",
      },
      {
        label: "Startup Funding",
        href: "/startups/startup-funding",
        description: "Funding pathways, grants, and investor access.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/startup_funding.png",
      },
    ],
    compact: true,
  },
    ...
    links: [
      {
        ...
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/impact.png",
      },
      {
        label: "Reward & Recognition",
        href: "/about/rewards",
        description: "Awards, accolades, and ecosystem milestones.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/rewared_recognition.png",
      },
      {
        label: "Reports",
        href: "/achieve/reports",
        description: "Annual reports, impact metrics, and data insights.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/reports.png",
      },
    ],
    compact: true,
  },
    ...
    links: [
      {
        ...
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/mentors.png",
      },
      {
        label: "Board",
        href: "/about/board",
        description: "Governance, leadership, and strategic oversight.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/board.png",
      },
      {
        label: "Team",
        href: "/about/team",
        description: "Core team, coordinators, and student leaders.",
        customIcon: "https://dtfhihp4ovn79.cloudfront.net/icons/team.png",
      },
    ],
    compact: true,
  },
  ...
  return (
    ...
    >
      <div ref={navRef} className="relative w-full" onMouseLeave={() => setActivePanel(null)}>
        ...
        >
          <div className="site-container-wide flex h-[58px] w-full items-center justify-between">
