...
const FALLBACK_CASE_STUDIES = [
  {
    ...
    image: "https://dtfhihp4ovn79.cloudfront.net/case_studies/GNY.AI.png",
  ...
  },
  {
    ...
    image: "https://dtfhihp4ovn79.cloudfront.net/case_studies/Green+jams.png",
  ...
  },
  {
    ...
    image: "https://dtfhihp4ovn79.cloudfront.net/case_studies/interview+buddy.png",
...
export function CaseStudiesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFAF7] font-sans antialiased text-[#0F172A] selection:bg-[#F58220]/20 selection:text-[#F58220]">
      ...
      {/* ── CTA Section ── */}
      <section className="site-container-wide pb-[120px]">
        <motion.div
