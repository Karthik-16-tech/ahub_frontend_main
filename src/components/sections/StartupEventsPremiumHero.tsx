...
const fallbackCollage = {
  main: "https://dtfhihp4ovn79.cloudfront.net/startup_events/startup-saturdays-sep-2025.jpg",
  card1: "https://dtfhihp4ovn79.cloudfront.net/startup_events/agriculture-entrepreneurship.webp",
  card2: "https://dtfhihp4ovn79.cloudfront.net/startup_events/IMG_3899.jpg",
  card3: "https://dtfhihp4ovn79.cloudfront.net/startup_events/startup-saturdays-nov-2024-1.jpg",
};
...
export function StartupEventsPremiumHero() {
  ...
  return (
    <main className="relative overflow-hidden bg-cream pt-4 pb-24">
      ...
      <section className="site-container-wide grid grid-cols-1 items-center gap-10 lg:grid-cols-[55fr_45fr] lg:gap-8">
        {/* LEFT */}
