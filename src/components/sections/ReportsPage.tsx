...
const AUIC_REPORTS = [
  {
    ...
    pages: 35,
    size: "4.5 MB",
    image: "https://dtfhihp4ovn79.cloudfront.net/reports/business+plan+for+a-hub.png",
    downloadFile: "https://dtfhihp4ovn79.cloudfront.net/reports/BUSINESS+PLANOF+A-HUB.pdf",
  },
  {
    ...
    pages: 28,
    size: "3.2 MB",
    image: "https://dtfhihp4ovn79.cloudfront.net/reports/funding+report.png",
    downloadFile: "https://dtfhihp4ovn79.cloudfront.net/reports/FUNDING+REPORT.pdf",
  },
  {
    ...
    pages: 42,
    size: "6.8 MB",
    image: "https://dtfhihp4ovn79.cloudfront.net/reports/vizag+startup+ecosystem.png",
    downloadFile: "https://dtfhihp4ovn79.cloudfront.net/reports/VIZAG+IIM+INTERN.pdf",
  },
];
...
const STARTUP_REPORTS = [
  {
    ...
    pages: 18,
    size: "0.9 MB",
    image: "https://dtfhihp4ovn79.cloudfront.net/reports/akshaya_aerospace.png",
    downloadFile: "https://dtfhihp4ovn79.cloudfront.net/reports/Akshaya+Aerospace+Technology+Private+Limited.pdf",
  },
  {
    ...
    pages: 22,
    size: "0.8 MB",
    image: "https://dtfhihp4ovn79.cloudfront.net/reports/ba_infotech.png",
    downloadFile: "https://dtfhihp4ovn79.cloudfront.net/reports/BA+Infotech+Private+Limited.pdf",
  },
  {
    ...
    pages: 20,
    size: "0.8 MB",
    image: "https://dtfhihp4ovn79.cloudfront.net/reports/joora_drones.png",
    downloadFile: "https://dtfhihp4ovn79.cloudfront.net/reports/JOORA+DRONES.pdf",
  },
];
...
export function ReportsPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      <div 
        className="w-full bg-[#FDF8F2] pt-24 pb-24"
