...
const SLIDES = [
  {
    ...
    img: "https://dtfhihp4ovn79.cloudfront.net/rewards/IIc+5.0+rating-4star.png",
  ...
  },
  {
    ...
    img: "https://dtfhihp4ovn79.cloudfront.net/rewards/IIc+4.0+rating+-4+star.png",
  ...
  },
  {
    ...
    img: "https://dtfhihp4ovn79.cloudfront.net/rewards/nirf+innovation+ranking+2023-+band+11-50.png",
                ...
                <div className="rw-showcase-right">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      >
                        <img loading="lazy" decoding="async" src={current.img} alt={current.alt} />
                      </div>
                    </motion.div>
                  </AnimatePresence>
                </div>
          ...
          <div className="rw-recognition">
            ...
            >
              ...
              <div
                ...
                onClick={() => setLightbox("https://dtfhihp4ovn79.cloudfront.net/rewards/nirf+innovation+ranking+2023-+band+11-50.png")}
              >
                <img loading="lazy" decoding="async" src="https://dtfhihp4ovn79.cloudfront.net/rewards/nirf+innovation+ranking+2023-+band+11-50.png" alt="NIRF Certificate" />
              </div>
            ...
            >
              ...
              <div
                className="rw-rec-img-wrap"
                onClick={() => setLightbox("https://dtfhihp4ovn79.cloudfront.net/rewards/IIc+4.0+rating+-4+star.png")}
              >
                <img loading="lazy" decoding="async" src="https://dtfhihp4ovn79.cloudfront.net/rewards/IIc+4.0+rating+-4+star.png" alt="IIC 4.0 Certificate" />
              </div>
          ...
          {lightbox && (
            ...
            >
              ...
              >
                ...
                <img loading="lazy" decoding="async" src={lightbox} alt="Certificate enlarged" />
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
