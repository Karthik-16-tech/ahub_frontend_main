    ...
    >
      ...
      <div className="flex items-center justify-center -mt-6 lg:-mt-16">
        <img loading="lazy" decoding="async"
          src="https://dtfhihp4ovn79.cloudfront.net/calender.png"
              ...
              selectedEvents.map((event) => (
                <div key={event.id} className="overflow-hidden rounded-xl bg-white shadow-sm border border-[#F5F0EB]">
                  <div className="relative aspect-[16/10] w-full overflow-hidden bg-[#FFF8F3] flex items-center justify-center">
                    <img loading="lazy" decoding="async" src={event.image} alt={event.title} className="h-full w-full object-contain" />
                  </div>
                  <div className="p-3">
              ...
              <div className="p-5 flex flex-col flex-1 bg-white">
                ...
                {event.instagram ? (
                  <a
                    ...
                    className="mt-4 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-[#833ab4] via-[#fd1d1d] to-[#fcb045] shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md hover:opacity-95 self-start cursor-pointer z-10"
                  ...
                  <a
                    href="https://www.instagram.com/ahub.in"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="View AHUB on Instagram"
                    className="mt-4 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-[#833ab4] via-[#fd1d1d] to-[#fcb045] shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md hover:opacity-95 self-start cursor-pointer z-10"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <Instagram className="h-4.5 w-4.5 text-white" />
